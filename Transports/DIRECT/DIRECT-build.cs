...
namespace Faction.Modules.Dotnet.Common
{
  class Transport : AgentTransport
  {
    ...
    public string Url = "https://172.16.70.132";
    public string KeyName = "79sQu_8ZVN6-FREm";
    public string Secret = "Q9QV3NndOWXQzg9Sk13wcnB7tGWHGdrt_d_x35mm8qW1EONLblb5e5zw4-qN-Ai_";
